...
export default class PageFind extends  React.PureComponent{
    ...
    _shareToWechatSession(){ // 分享到微信会话
        WeChat.webShareWeXinWithScene(0,'葡萄互助','点击加入葡萄互助，得5元红包','http://www.baidu.com/img/baidu_sylogo1.gif','http://wap.baidu.com/',(err,sendOK) => {
            console.log(sendOK)
        });
    }

    _shareToWechatPengyouQuan(){ //分享到朋友圈
        WeChat.webShareWeXinWithScene(1,'葡萄互助','点击加入葡萄互助，得5元红包','http://www.baidu.com/img/baidu_sylogo1.gif','http://wap.baidu.com/',(err,sendOK) => {
            console.log(sendOK)
        });
    }

    _shareToqqSession(){ //分享到qq会话
        QQSDK.shareNews('https://facebook.github.io/react-native/',resolveAssetSource(require('./img/aboutus.png')).uri,'分享新闻标题','分享新闻描述',shareScene.QQ)
                    ...
                    <View style={styles.ModalWrapper}>
                        ...
                        <View style={styles.closeWrapper}>
                            <View style={styles.close}>
                                <Text   onPress={this.setModalHidden.bind(this)} style={{width:46,color:'#fff'}}>关闭</Text>
                            </View>
                        </View>
                    </View>
                </Modal>
